...
#define buf_writer_get_cbopaque JEMALLOC_N(buf_writer_get_cbopaque)
#define buf_writer_get_write_cb JEMALLOC_N(buf_writer_get_write_cb)
...
#define ecache_grow_init JEMALLOC_N(ecache_grow_init)
#define ecache_grow_postfork_child JEMALLOC_N(ecache_grow_postfork_child)
#define ecache_grow_postfork_parent JEMALLOC_N(ecache_grow_postfork_parent)
#define ecache_grow_prefork JEMALLOC_N(ecache_grow_prefork)
...
#define emap_global JEMALLOC_N(emap_global)
...
#define stats_interval_accum JEMALLOC_N(stats_interval_accum)
#define stats_interval_accum_batch_size JEMALLOC_N(stats_interval_accum_batch_size)
...
#define te_alloc_rollback JEMALLOC_N(te_alloc_rollback)
...
#define te_event_update JEMALLOC_N(te_event_update)
